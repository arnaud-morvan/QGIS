...
class ImportIntoPostGIS(GeoAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.addParameter(ParameterString(
            ...
            metadata={
                'widget_wrapper': {
                    'class': 'processing.gui.wrappers.postgis.ConnectionWidgetWrapper'}}))
        self.addParameter(ParameterString(
            self.SCHEMA,
            ...
            metadata={
                'widget_wrapper': {
                    'class': 'processing.gui.wrappers.postgis.SchemaWidgetWrapper',
        ...
        self.addParameter(ParameterString(
            ...
            metadata={
                'widget_wrapper': {
                    'class': 'processing.gui.wrappers.postgis.TableWidgetWrapper',
